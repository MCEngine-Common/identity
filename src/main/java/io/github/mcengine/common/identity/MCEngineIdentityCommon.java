...
public class MCEngineIdentityCommon {
    ...
    /**
     * Adds (or refreshes) a permission entry for a specific alt belonging to the player.
     * <p>
     ...
     * @param permName the permission name to record
     * @return {@code true} if written (or updated), {@code false} otherwise
     */
